    ...
    return (
        <div className="graphic-editor-container">
            <div className='graphic-editor-buttons'>
                <button className="graphic-edit-button" id='up-button' onClick={() => handleMoveGraphic('vert', -30)} ><FaArrowUp /></button>
                <button className="graphic-edit-button" id='down-button' onClick={() => handleMoveGraphic('vert', 30)} ><FaArrowDown /></button>
                <button className="graphic-edit-button" id='left-button' onClick={() => handleMoveGraphic('hor', -30)} ><FaArrowLeft /></button>
                <button className="graphic-edit-button" id='right-button' onClick={() => handleMoveGraphic('hor', 30)} ><FaArrowRight /></button>
                <button className="graphic-edit-button" id='scale-up-button' onClick={() => handleMoveGraphic('scale', 1.1)} ><FaArrowsAlt /></button>
                <button className="graphic-edit-button" id='scale-down-button' onClick={() => handleMoveGraphic('scale', 0.9)} ><FaCompressArrowsAlt /></button>
